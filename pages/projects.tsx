...
const ProjectsPage = () => {
  ...
  // Define category order: Hardware first, then Arceus Labs, then Ragastra, then Circuits, then Software
  const categoryOrder: ProjectCategory[] = ['HARDWARE_MODULES', 'COMMUNITY_PROJECT', 'RAGASTRA_PROJECT', 'CIRCUITS', 'SOFTWARE_SYSTEMS', 'MISC_LABS'];
