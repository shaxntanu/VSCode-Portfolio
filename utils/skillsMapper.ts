...
export const projectSkillMappings: Record<string, string[]> = {
  'zephyr-station': ['ESP32', 'BME280', 'OLED', 'I2C', 'SPI', 'MQTT', 'C++'],
  'jolt-locator': ['ESP32', 'GPS', 'OLED', 'I2C', 'UART', 'C++'],
  'the-ruin-machine': ['ESP32', 'OLED', 'I2C', 'C++'],
  'electromagnet-controller': ['Arduino', 'C++'],
  'inductance-meter': ['ESP32', 'OLED', 'I2C', 'C++'],
  'servo-light-switch': ['ESP32', 'C++'],
  'rfid-attendance-system': ['Arduino', 'ESP32', 'OLED', 'SPI', 'I2C', 'C++'],
